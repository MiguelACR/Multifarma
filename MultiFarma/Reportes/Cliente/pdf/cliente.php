...
<div id="page_pdf">
	...
	<table id="detalle_head">
			...
			<?php
				...
				if($detalle_clientes > 0){

					foreach($detalle_clientes as $contenido){
			 ?>
				<tr>
					<td class="textcenter"><?php echo $contenido->id_cliente; ?></td>
					<td><?php echo $contenido->nombre_cliente; ?></td>
					<td><?php echo $contenido->apellido_cliente; ?></td>
                    <td><?php echo $contenido->direccion_cliente; ?></td>
                    <td><?php echo $contenido->telefono_cliente; ?></td>
                    <td><?php echo $contenido->nombre_pais; ?></td>
                    <td><?php echo $contenido->nombre_ciudad; ?></td>
                    <td><?php echo $contenido->email_cliente; ?></td>
				</tr> 
